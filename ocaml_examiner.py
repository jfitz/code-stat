...
from fsharp_examiner import FsharpCharTokenBuilder
from examiner import Examiner

class OcamlExaminer(Examiner):
  @staticmethod
  def __escape_z__():
    ...
    FsharpCharTokenBuilder.__escape_z__()
    return 'Escape ?Z'
  ...
  def __init__(self, code):
    ...
    types = [
      'bool', 'byte', 'char', 'double', 'float', 'int', 'long', 'object',
      'string', 'void',
      'range', 'unit', 'number'
    ]
