...
# Ada-83
test\bin\run_test.ps1 -json -name adabkend-adb-83 -action confidence -language "ada-83 ada-95 basic c pl1 swift" -inputfile ".\test\data\Ada-83\adabkend.adb" -expected ".\test\ref\detect-confidence\adabkend-adb.txt"
...
# C-99
test\bin\run_test.ps1 -json -name parser-h-99 -action confidence -language "C python swift" -inputfile ".\test\data\C-99\parser.h" -expected ".\test\ref\detect-confidence\parser-h.txt"
test\bin\run_test.ps1 -json -name parser-c-99 -action confidence -language "C C++ pascal" -inputfile ".\test\data\C-99\parser.c" -expected ".\test\ref\detect-confidence\parser-c.txt"
...
# COBOL-85
test\bin\run_test.ps1 -json -name prog15-4-85 -action confidence -language "COBOL-85 pascal pl1" -inputfile ".\test\data\COBOL-85\PROG15-4.COB" -expected ".\test\ref\detect-confidence\PROG15-4.txt"
...
# PL/1
test\bin\run_test.ps1 -json -name bpgpli-pl1 -action confidence -language "PL1 fortran-77 cobol-85" -inputfile ".\test\data\PL1\BPGPLI.pl1" -expected ".\test\ref\detect-confidence\BPGPLI.txt"
