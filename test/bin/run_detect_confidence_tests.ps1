...
# COBOL-85
test\bin\run_test.ps1 -json -name prog15-4-85 -action confidence -language "COBOL-85 pascal pl1-fixed" -inputfile ".\test\data\COBOL-85\PROG15-4.COB" -expected ".\test\ref\detect-confidence\PROG15-4.txt"
