...
test\bin\run_test.ps1 -json -name freeformat1 -action confidence -language Free-Format-COBOL -inputfile ".\test\data\COBOL\Free Format 1.COB" -expected ".\test\ref\confidence\COBOL\Free Format 1.txt"
test\bin\run_test.ps1 -json -name freeformat2 -action confidence -language Free-Format-COBOL -inputfile ".\test\data\COBOL\Free Format 2.COB" -expected ".\test\ref\confidence\COBOL\Free Format 2.txt"
test\bin\run_test.ps1 -json -name freeformat3 -action confidence -language Free-Format-COBOL -inputfile ".\test\data\COBOL\Free Format 3.COB" -expected ".\test\ref\confidence\COBOL\Free Format 3.txt"
test\bin\run_test.ps1 -json -name freeformat4 -action confidence -language Free-Format-COBOL -inputfile ".\test\data\COBOL\Free Format 4.COB" -expected ".\test\ref\confidence\COBOL\Free Format 4.txt"
