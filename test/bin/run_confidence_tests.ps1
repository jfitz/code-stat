...
# generic assembly
test\bin\run_test.ps1 -json -name subroutine1-asm -action confidence -language assembly -inputfile ".\test\data\ASM-360\subroutine1.asm" -expected ".\test\ref\confidence\Assembly\subroutine1.txt"
