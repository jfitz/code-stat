...
test\bin\run_test.ps1 -json -name decl-c-78 -action confidence -language C-78 -inputfile ".\test\data\C-78\c-decl.c" -expected ".\test\ref\confidence\C-78\c-decl-c.txt"
