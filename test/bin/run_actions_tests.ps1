...
test\bin\run_tests_language.ps1 -language "Assembly" -variants ("ASM-360", "ASM-370", "ASM-390", "ASM-1802", "ASM-6502", "ASM-6800", "ASM-68000", "ASM-8080", "ASM-Z-80", "ASM-8086", "ASM-80386", "ASM-PDP-8", "ASM-PDP-11")

# Ada 83
test\bin\run_tests_language.ps1 -language "Ada" -variants ("Ada-83", "Ada-95")
...
# C and Objective-C
test\bin\run_tests_language.ps1 -language "C" -variants ("C-78", "C-89", "C-99", "Objective-C")

# CBASIC
test\bin\run_tests_language.ps1 -language "CBASIC" -variants ("CBASIC")

# COBOL
test\bin\run_tests_language.ps1 -language "COBOL" -variants ("COBOL-68", "COBOL-74", "COBOL-85", "COBOL-2014", "COBOL-2014-ACU", "COBOL-2014-GNU", "COBOL-2014-IBM")

# C++
test\bin\run_tests_language.ps1 -language "Cplusplus" -variants ("Cplusplus")

# C#
test\bin\run_tests_language.ps1 -language "Csharp" -variants ("Csharp")

# D
test\bin\run_tests_language.ps1 -language "D" -variants ("D")

# Dart
test\bin\run_tests_language.ps1 -language "Dart" -variants ("Dart")

# dbase
test\bin\run_tests_language.ps1 -language "dbase" -variants ("dbase-ii", "dbase-iii")

# Dibol
test\bin\run_tests_language.ps1 -language "Dibol" -variants ("Dibol")

# Eiffel
test\bin\run_tests_language.ps1 -language "Eiffel" -variants ("Eiffel")

# Erlang
test\bin\run_tests_language.ps1 -language "Erlang" -variants ("Erlang")

# Flowmatic
test\bin\run_tests_language.ps1 -language "Flowmatic" -variants ("Flowmatic")

# FORTRAN
test\bin\run_tests_language.ps1 -language "FORTRAN" -variants ("FORTRAN-66", "FORTRAN-77", "Fortran-90", "Fortran-95", "Fortran-2003")

# F#
test\bin\run_tests_language.ps1 -language "Fsharp" -variants ("Fsharp")

# Go
test\bin\run_tests_language.ps1 -language "Go" -variants ("Go")

# Groovy
test\bin\run_tests_language.ps1 -language "Groovy" -variants ("Groovy")

# Haskell
test\bin\run_tests_language.ps1 -language "Haskell" -variants ("Haskell")

# HTML
test\bin\run_tests_language.ps1 -language "HTML" -variants ("HTML")

# Intercal
test\bin\run_tests_language.ps1 -language "Intercal" -variants ("Intercal")

# Java
test\bin\run_tests_language.ps1 -language "Java" -variants ("Java")

# JavaScript and TypeScript and CoffeeScript
test\bin\run_tests_language.ps1 -language "JavaScript" -variants ("JavaScript", "TypeScript", "CoffeeScript")

# Julia
test\bin\run_tests_language.ps1 -language "Julia" -variants ("Julia")

# Kotlin
test\bin\run_tests_language.ps1 -language "Kotlin" -variants ("Kotlin")

# Latino
test\bin\run_tests_language.ps1 -language "Latino" -variants ("Latino")

# Lua
test\bin\run_tests_language.ps1 -language "Lua" -variants ("Lua")

# Matlab and Octave
test\bin\run_tests_language.ps1 -language "Matlab" -variants ("Matlab", "Octave")

# OCaml
test\bin\run_tests_language.ps1 -language "ML" -variants ("OCaml")

# Pascal and Delphi and Modula-2
test\bin\run_tests_language.ps1 -language "Pascal" -variants ("Pascal", "Delphi", "Modula-2")

# Perl
test\bin\run_tests_language.ps1 -language "Perl" -variants ("Perl")

# PL/1 and PL/M
test\bin\run_tests_language.ps1 -language "PL1" -variants ("PL1", "PLM")

# Prolog
test\bin\run_tests_language.ps1 -language "Prolog" -variants ("Prolog")

# Python
test\bin\run_tests_language.ps1 -language "Python" -variants ("Python")

# R
test\bin\run_tests_language.ps1 -language "R" -variants ("R")

# Ruby
test\bin\run_tests_language.ps1 -language "Ruby" -variants ("Ruby")

# Rust
test\bin\run_tests_language.ps1 -language "Rust" -variants ("Rust")

# Scala
test\bin\run_tests_language.ps1 -language "Scala" -variants ("Scala")

# SQL, PL/SQL, and T-SQL
test\bin\run_tests_language.ps1 -language "SQL" -variants ("SQL", "PL-SQL", "T-SQL")

# Swift
test\bin\run_tests_language.ps1 -language "Swift" -variants ("Swift")

# Visual Basic
test\bin\run_tests_language.ps1 -language "VisualBasic" -variants ("VisualBasic-6", "VisualBasic-NET")
