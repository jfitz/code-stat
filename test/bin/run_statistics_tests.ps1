...
test\bin\run_test.ps1 -json -name microsoft -action statistics -language generic -inputfile ".\test\data\SQL\microsoft.sql" -expected ".\test\ref\statistics\generic\microsoft.txt"
...
test\bin\run_test.ps1 -json -name microsoft -action statistics -language generic -comment ada -inputfile ".\test\data\SQL\microsoft.sql" -expected ".\test\ref\statistics\generic-comments\microsoft.txt"
...
test\bin\run_test.ps1 -json -name subroutine1_a-asm -action statistics -language ASM-360 -inputfile ".\test\data\ASM-360\subroutine1_a.asm" -expected ".\test\ref\statistics\ASM-360\subroutine1_a.txt"
...
test\bin\run_test.ps1 -json -name subroutine2_a-asm -action statistics -language ASM-360 -inputfile ".\test\data\ASM-360\subroutine2_a.asm" -expected ".\test\ref\statistics\ASM-360\subroutine2_a.txt"
...
# ASM 1802
test\bin\run_test.ps1 -json -name test_alu-asm -action statistics -language asm-1802 -inputfile ".\test\data\ASM-1802\test_alu.asm" -expected ".\test\ref\statistics\ASM-1802\test_alu.txt"
...
# ASM 68000
test\bin\run_test.ps1 -json -name basic68k-asm -action statistics -language asm-68000 -inputfile ".\test\data\ASM-68000\basic68k.asm" -expected ".\test\ref\statistics\ASM-68000\basic68k.txt"
test\bin\run_test.ps1 -json -name sprites-asm -action statistics -language asm-68000 -inputfile ".\test\data\ASM-68000\sprites.asm" -expected ".\test\ref\statistics\ASM-68000\sprites.txt"
...
test\bin\run_test.ps1 -json -name DSKCOM-asm -action statistics -language asm-8086 -inputfile ".\test\data\ASM-8086\DSKCOM.asm" -expected ".\test\ref\statistics\ASM-8086\DSKCOM.txt"
test\bin\run_test.ps1 -json -name FIVEO-asm -action statistics -language asm-8086 -inputfile ".\test\data\ASM-8086\FIVEO.asm" -expected ".\test\ref\statistics\ASM-8086\FIVEO.txt"
...
# ASM-PDP-8
test\bin\run_test.ps1 -json -name io-asm -action statistics -language asm-pdp-8 -inputfile ".\test\data\ASM-PDP-8\io.asm" -expected ".\test\ref\statistics\ASM-PDP-8\io.txt"
test\bin\run_test.ps1 -json -name life-asm -action statistics -language asm-pdp-8 -inputfile ".\test\data\ASM-PDP-8\life.asm" -expected ".\test\ref\statistics\ASM-PDP-8\life.txt"
test\bin\run_test.ps1 -json -name sum-asm -action statistics -language asm-pdp-8 -inputfile ".\test\data\ASM-PDP-8\sum.asm" -expected ".\test\ref\statistics\ASM-PDP-8\sum.txt"

# ASM-PDP-11
test\bin\run_test.ps1 -json -name print-asm -action tokens -language asm-pdp-11 -inputfile ".\test\data\ASM-PDP-11\print.asm" -expected ".\test\ref\statistics\ASM-PDP-11\print.txt"
test\bin\run_test.ps1 -json -name k11tsx-asm -action statistics -language asm-pdp-11 -inputfile ".\test\data\ASM-PDP-11\k11tsx.mac" -expected ".\test\ref\statistics\ASM-PDP-11\k11tsx.txt"
test\bin\run_test.ps1 -json -name krtser-asm -action statistics -language asm-pdp-11 -inputfile ".\test\data\ASM-PDP-11\krtser.mac" -expected ".\test\ref\statistics\ASM-PDP-11\krtser.txt"
test\bin\run_test.ps1 -json -name krtsub-asm -action statistics -language asm-pdp-11 -inputfile ".\test\data\ASM-PDP-11\krtsub.mac" -expected ".\test\ref\statistics\ASM-PDP-11\krtsub.txt"
...
# BASIC-80
test\bin\run_test.ps1 -json -name doctor-mbasic -action statistics -language BASIC-80 -inputfile ".\test\data\BASIC\doctor.bas" -expected ".\test\ref\statistics\BASIC-80\doctor.txt"
test\bin\run_test.ps1 -json -name airinput-mbasic -action statistics -language BASIC-80 -inputfile ".\test\data\BASIC\AIRINPUT.bas" -expected ".\test\ref\statistics\BASIC-80\AIRINPUT.txt"
test\bin\run_test.ps1 -json -name backgamm-mbasic -action statistics -language BASIC-80 -inputfile ".\test\data\BASIC\BACKGAMM.bas" -expected ".\test\ref\statistics\BASIC-80\BACKGAMM.txt"
test\bin\run_test.ps1 -json -name planes-mbasic -action statistics -language BASIC-80 -inputfile ".\test\data\BASIC\PLANES.bas" -expected ".\test\ref\statistics\BASIC-80\PLANES.txt"
...
test\bin\run_test.ps1 -json -name j_interpreter-c-78 -action statistics -language C-78 -inputfile ".\test\data\C-78\j_interpreter.c" -expected ".\test\ref\statistics\C-78\j_interpreter.txt"

# C-89

# C-99
test\bin\run_test.ps1 -json -name decl-c-99 -action statistics -language C-99 -inputfile ".\test\data\C-99\c-decl.c" -expected ".\test\ref\statistics\C-99\c-decl-c.txt"
...
test\bin\run_test.ps1 -json -name invmaint-dbii -action statistics -language dbase-II -inputfile ".\test\data\dbase-II\INVMAINT.PRG" -expected ".\test\ref\statistics\dbase-II\INVMAINT.txt"
test\bin\run_test.ps1 -json -name invquan-dbii -action statistics -language dbase-II -inputfile ".\test\data\dbase-II\INVQUAN.PRG" -expected ".\test\ref\statistics\dbase-II\INVQUAN.txt"
test\bin\run_test.ps1 -json -name invread-dbii -action statistics -language dbase-II -inputfile ".\test\data\dbase-II\INVREAD.PRG" -expected ".\test\ref\statistics\dbase-II\INVREAD.txt"
test\bin\run_test.ps1 -json -name invrprt-dbii -action statistics -language dbase-II -inputfile ".\test\data\dbase-II\INVRPRT.PRG" -expected ".\test\ref\statistics\dbase-II\INVRPRT.txt"
...
# Dibol
test\bin\run_test.ps1 -json -name bottles-dibol -action statistics -language Dibol -inputfile ".\test\data\Dibol\bottles.dbl" -expected ".\test\ref\statistics\Dibol\bottles.txt"
...
# Erlang
test\bin\run_test.ps1 -json -name armstrong-erlang -action statistics -language Erlang -inputfile ".\test\data\Erlang\armstrong.erl" -expected ".\test\ref\statistics\Erlang\armstrong.txt"
test\bin\run_test.ps1 -json -name list_comprehension-erlang -action statistics -language Erlang -inputfile ".\test\data\Erlang\list_comprehension.erl" -expected ".\test\ref\statistics\Erlang\list_comprehension.txt"
test\bin\run_test.ps1 -json -name send_receive-erlang -action statistics -language Erlang -inputfile ".\test\data\Erlang\send_receive.erl" -expected ".\test\ref\statistics\Erlang\send_receive.txt"
...
test\bin\run_test.ps1 -json -name antwalk-fs -action statistics -language Fsharp -inputfile ".\test\data\Fsharp\ant_walk.fs" -expected ".\test\ref\statistics\Fsharp\ant_walk.txt"
...
test\bin\run_test.ps1 -json -name rna-hs -action statistics -language Haskell -inputfile ".\test\data\Haskell\rna.hs" -expected ".\test\ref\statistics\Haskell\rna.txt"
...
test\bin\run_test.ps1 -json -name jsonkit_h-objc -action statistics -language Objective-C -inputfile ".\test\data\Objective-C\JSONKit.h" -expected ".\test\ref\statistics\Objective-C\JSONKit_h.txt"
test\bin\run_test.ps1 -json -name jsonkit_m-objc -action statistics -language Objective-C -inputfile ".\test\data\Objective-C\JSONKit.m" -expected ".\test\ref\statistics\Objective-C\JSONKit_m.txt"

# OCaml
test\bin\run_test.ps1 -json -name antwalk-ocaml -action statistics -language OCaml -inputfile ".\test\data\OCaml\ant_walk.ml" -expected ".\test\ref\statistics\OCaml\ant_walk.txt"

# Octave
test\bin\run_test.ps1 -json -name transpose-octave -action statistics -language Octave -inputfile ".\test\data\Octave\transpose.m" -expected ".\test\ref\statistics\Octave\transpose.txt"
test\bin\run_test.ps1 -json -name choose-octave -action statistics -language Octave -inputfile ".\test\data\Octave\choose.m" -expected ".\test\ref\statistics\Octave\choose.txt"
test\bin\run_test.ps1 -json -name fitnormal-octave -action statistics -language Octave -inputfile ".\test\data\Octave\fitnormal.m" -expected ".\test\ref\statistics\Octave\fitnormal.txt"
test\bin\run_test.ps1 -json -name test_fitnormal-octave -action statistics -language Octave -inputfile ".\test\data\Octave\test_fitnormal.m" -expected ".\test\ref\statistics\Octave\test_fitnormal.txt"
test\bin\run_test.ps1 -json -name tshow-octave -action statistics -language Octave -inputfile ".\test\data\Octave\tshow.m" -expected ".\test\ref\statistics\Octave\tshow.txt"
test\bin\run_test.ps1 -json -name ex7_pca-octave -action statistics -language Octave -inputfile ".\test\data\Octave\ex7_pca.m" -expected ".\test\ref\statistics\Octave\ex7_pca.txt"

# Pascal
test\bin\run_test.ps1 -json -name label_declare-pas -action statistics -language Pascal -inputfile ".\test\data\Pascal\LabelDeclaration.pas" -expected ".\test\ref\statistics\Pascal\LabelDeclaration.txt"
...
# Perl
test\bin\run_test.ps1 -json -name perligata-perl -action statistics -language Perl -inputfile ".\test\data\Perl\Perligata.pm" -expected ".\test\ref\statistics\Perl\Perligata.txt"
test\bin\run_test.ps1 -json -name physics-perl -action statistics -language Perl -inputfile ".\test\data\Perl\Physics.pm" -expected ".\test\ref\statistics\Perl\Physics.txt"
