...
# generic
test\bin\run_test.ps1 -json -name adabkend-adb -action statistics -inputfile ".\test\data\Ada-83\adabkend.adb" -expected ".\test\ref\statistics\generic\adabkend-adb.txt"
test\bin\run_test.ps1 -json -name rockt2 -action statistics -inputfile ".\test\data\BASIC\rockt2.bas" -expected ".\test\ref\statistics\generic\rockt2.txt"
test\bin\run_test.ps1 -json -name parser -action statistics -inputfile ".\test\data\C\parser.c" -expected ".\test\ref\statistics\generic\parser.txt"
test\bin\run_test.ps1 -json -name PROG13-3 -action statistics -inputfile ".\test\data\COBOL-85\PROG13-3.cob" -expected ".\test\ref\statistics\generic\prog13-3.txt"
test\bin\run_test.ps1 -json -name calculator3 -action statistics -inputfile ".\test\data\Csharp\calculator3.cs" -expected ".\test\ref\statistics\generic\calculator3.txt"
test\bin\run_test.ps1 -json -name heron -action statistics -inputfile ".\test\data\FORTRAN-77\HERON.F77" -expected ".\test\ref\statistics\generic\heron.txt"
test\bin\run_test.ps1 -json -name bing -action statistics -inputfile ".\test\data\JavaScript\bing.js" -expected ".\test\ref\statistics\generic\bing.txt"
test\bin\run_test.ps1 -json -name family-main -action statistics -inputfile ".\test\data\Prolog\family-main.pl" -expected ".\test\ref\statistics\generic\family-main.txt"
test\bin\run_test.ps1 -json -name ETM-540-05 -action statistics -inputfile ".\test\data\R\ETM-540-05.R" -expected ".\test\ref\statistics\generic\etm-540-05.txt"
test\bin\run_test.ps1 -json -name basic -action statistics -inputfile ".\test\data\Ruby\basic.rb" -expected ".\test\ref\statistics\generic\basic.txt"
test\bin\run_test.ps1 -json -name microsoft -action statistics -inputfile ".\test\data\SQL-92\microsoft.sql" -expected ".\test\ref\statistics\generic\microsoft.txt"
test\bin\run_test.ps1 -json -name spider -action statistics -inputfile ".\test\data\VisualBasic-6\spider.bas" -expected ".\test\ref\statistics\generic\spider.txt"

# generic with comments
test\bin\run_test.ps1 -json -name adabkend-adb -action statistics -comment ada -inputfile ".\test\data\Ada-83\adabkend.adb" -expected ".\test\ref\statistics\generic-comments\adabkend-adb.txt"
test\bin\run_test.ps1 -json -name rockt2 -action statistics -comment basic -inputfile ".\test\data\BASIC\rockt2.bas" -expected ".\test\ref\statistics\generic-comments\rockt2.txt"
test\bin\run_test.ps1 -json -name parser -action statistics -comment c -inputfile ".\test\data\C\parser.c" -expected ".\test\ref\statistics\generic-comments\parser.txt"
test\bin\run_test.ps1 -json -name PROG13-3 -action statistics -comment cobol -inputfile ".\test\data\COBOL-85\PROG13-3.cob" -expected ".\test\ref\statistics\generic-comments\prog13-3.txt"
test\bin\run_test.ps1 -json -name calculator3 -action statistics -comment cpp -inputfile ".\test\data\Csharp\calculator3.cs" -expected ".\test\ref\statistics\generic-comments\calculator3.txt"
test\bin\run_test.ps1 -json -name heron -action statistics -comment fortran -inputfile ".\test\data\FORTRAN-77\HERON.F77" -expected ".\test\ref\statistics\generic-comments\heron.txt"
test\bin\run_test.ps1 -json -name bing -action statistics -comment hash -inputfile ".\test\data\JavaScript\bing.js" -expected ".\test\ref\statistics\generic-comments\bing.txt"
test\bin\run_test.ps1 -json -name family-main -action statistics -comment percent -inputfile ".\test\data\Prolog\family-main.pl" -expected ".\test\ref\statistics\generic-comments\family-main.txt"
test\bin\run_test.ps1 -json -name ETM-540-05 -action statistics -comment hash -inputfile ".\test\data\R\ETM-540-05.R" -expected ".\test\ref\statistics\generic-comments\etm-540-05.txt"
test\bin\run_test.ps1 -json -name basic -action statistics -comment hash -inputfile ".\test\data\Ruby\basic.rb" -expected ".\test\ref\statistics\generic-comments\basic.txt"
test\bin\run_test.ps1 -json -name microsoft -action statistics -comment ada -inputfile ".\test\data\SQL-92\microsoft.sql" -expected ".\test\ref\statistics\generic-comments\microsoft.txt"
test\bin\run_test.ps1 -json -name spider -action statistics -comment basic -inputfile ".\test\data\VisualBasic-6\spider.bas" -expected ".\test\ref\statistics\generic-comments\spider.txt"
...
test\bin\run_test.ps1 -json -name values-c -action statistics -language C -inputfile ".\test\data\C\values.c" -expected ".\test\ref\statistics\C\values.txt"
