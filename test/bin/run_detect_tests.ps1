...
test\bin\run_test.ps1 -json -name freeformat1 -action detect -inputfile ".\test\data\COBOL\Free Format 1.COB" -expected ".\test\ref\detect\COBOL\Free Format 1.txt"
test\bin\run_test.ps1 -json -name freeformat2 -action detect -inputfile ".\test\data\COBOL\Free Format 2.COB" -expected ".\test\ref\detect\COBOL\Free Format 2.txt"
test\bin\run_test.ps1 -json -name freeformat3 -action detect -inputfile ".\test\data\COBOL\Free Format 3.COB" -expected ".\test\ref\detect\COBOL\Free Format 3.txt"
test\bin\run_test.ps1 -json -name freeformat4 -action detect -inputfile ".\test\data\COBOL\Free Format 4.COB" -expected ".\test\ref\detect\COBOL\Free Format 4.txt"
