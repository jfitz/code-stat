...
test\bin\run_test.ps1 -name hrdb -action detect -inputfile ".\test\data\Cpp\hrdb.cpp" -expected ".\test\ref\detect\Cpp\hrdb.txt"
test\bin\run_test.ps1 -name date_h -action detect -inputfile ".\test\data\Cpp\date.h" -expected ".\test\ref\detect\Cpp\date_h.txt"
test\bin\run_test.ps1 -name date_cpp -action detect -inputfile ".\test\data\Cpp\date.cpp" -expected ".\test\ref\detect\Cpp\date_cpp.txt"
