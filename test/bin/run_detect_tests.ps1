...
test\bin\run_test.ps1 -json -name prog1-68 -action detect -inputfile ".\test\data\COBOL-68\PROG1.COB" -expected ".\test\ref\detect\COBOL-68\PROG1.txt"
test\bin\run_test.ps1 -json -name prog2-68 -action detect -inputfile ".\test\data\COBOL-68\PROG2.COB" -expected ".\test\ref\detect\COBOL-68\PROG2.txt"
test\bin\run_test.ps1 -json -name prog2A-68 -action detect -inputfile ".\test\data\COBOL-68\PROG2A.COB" -expected ".\test\ref\detect\COBOL-68\PROG2A.txt"
...
test\bin\run_test.ps1 -json -name P010-wide-2002 -action detect -inputfile ".\test\data\COBOL-2002\P010-wide.COB" -wide -expected ".\test\ref\detect\COBOL-2002\P010-wide.txt"
...
test\bin\run_test.ps1 -json -name emain-dbii -action detect -inputfile ".\test\data\dbase-II\EMAIN.PRG" -expected ".\test\ref\detect\dbase-II\EMAIN.txt"
test\bin\run_test.ps1 -json -name emp-entr-dbii -action detect -inputfile ".\test\data\dbase-II\EMP-ENTR.PRG" -expected ".\test\ref\detect\dbase-II\EMP-ENTR.txt"
test\bin\run_test.ps1 -json -name emp-rprt-dbii -action detect -inputfile ".\test\data\dbase-II\EMP-RPRT.PRG" -expected ".\test\ref\detect\dbase-II\EMP-RPRT.txt"
...
test\bin\run_test.ps1 -json -name invmaint-dbii -action detect -inputfile ".\test\data\dbase-II\INVMAINT.PRG" -expected ".\test\ref\detect\dbase-II\INVMAINT.txt"
test\bin\run_test.ps1 -json -name invquan-dbii -action detect -inputfile ".\test\data\dbase-II\INVQUAN.PRG" -expected ".\test\ref\detect\dbase-II\INVQUAN.txt"
test\bin\run_test.ps1 -json -name invread-dbii -action detect -inputfile ".\test\data\dbase-II\INVREAD.PRG" -expected ".\test\ref\detect\dbase-II\INVREAD.txt"
test\bin\run_test.ps1 -json -name invrprt-dbii -action detect -inputfile ".\test\data\dbase-II\INVRPRT.PRG" -expected ".\test\ref\detect\dbase-II\INVRPRT.txt"
...
test\bin\run_test.ps1 -json -name temp-sub-ftn90 -action detect -inputfile ".\test\data\Fortran-90\temp_sub.for" -expected ".\test\ref\detect\Fortran-90\temp_sub.txt"
test\bin\run_test.ps1 -json -name temp-func-ftn90 -action detect -inputfile ".\test\data\Fortran-90\temp_func.for" -expected ".\test\ref\detect\Fortran-90\temp_func.txt"
test\bin\run_test.ps1 -json -name Wikibooks-ex2-ftn90 -action detect -inputfile ".\test\data\Fortran-90\Wikibooks-ex2.f95" -expected ".\test\ref\detect\Fortran-90\Wikibooks-ex2.txt"
...
# Fortran-2003
test\bin\run_test.ps1 -json -name average-ftn2003 -action detect -inputfile ".\test\data\Fortran-2003\average.f90" -expected ".\test\ref\detect\Fortran-2003\average.txt"
...
test\bin\run_test.ps1 -json -name Wikibooks-ex3-ftn2003 -action detect -inputfile ".\test\data\Fortran-2003\Wikibooks-ex3.f95" -expected ".\test\ref\detect\Fortran-2003\Wikibooks-ex3.txt"
test\bin\run_test.ps1 -json -name Wikibooks-ex4-ftn2003 -action detect -inputfile ".\test\data\Fortran-2003\Wikibooks-ex4.f95" -expected ".\test\ref\detect\Fortran-2003\Wikibooks-ex4.txt"
