...
# C
test\bin\run_test.ps1 -json -name parser-h -action confidence -errors -language "C python swift" -inputfile ".\test\data\C\parser.h" -expected ".\test\ref\detect-confidence-errors\parser-h.txt"
test\bin\run_test.ps1 -json -name parser-c -action confidence -errors -language "C C++ pascal" -inputfile ".\test\data\C\parser.c" -expected ".\test\ref\detect-confidence-errors\parser-c.txt"
...
# COBOL-74
test\bin\run_test.ps1 -json -name prog15-4-74 -action confidence -errors -language "COBOL-74 pascal pl1-fixed" -inputfile ".\test\data\COBOL-74\PROG15-4.COB" -expected ".\test\ref\detect-confidence-errors\PROG15-4.txt"
