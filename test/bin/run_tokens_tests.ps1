...
# ASM IBM-370
test\bin\run_test.ps1 -json -name asm370a1-asm -action tokens -language ASM-370 -inputfile ".\test\data\ASM-370\asm370a1.asm" -expected ".\test\ref\tokens\ASM-370\asm370a1.txt"

# ASM IBM-390
test\bin\run_test.ps1 -json -name osint-asm -action tokens -language ASM-390 -inputfile ".\test\data\ASM-390\osint.asm" -expected ".\test\ref\tokens\ASM-390\osint.txt"
...
# ASM 68000
test\bin\run_test.ps1 -json -name basic68k-asm -action tokens -language asm-68000 -inputfile ".\test\data\ASM-68000\basic68k.asm" -expected ".\test\ref\tokens\ASM-68000\basic68k.txt"
test\bin\run_test.ps1 -json -name sprites-asm -action tokens -language asm-68000 -inputfile ".\test\data\ASM-68000\sprites.asm" -expected ".\test\ref\tokens\ASM-68000\sprites.txt"
...
# Erlang
test\bin\run_test.ps1 -json -name armstrong-erlang -action tokens -language Erlang -inputfile ".\test\data\Erlang\armstrong.erl" -expected ".\test\ref\tokens\Erlang\armstrong.txt"
test\bin\run_test.ps1 -json -name list_comprehension-erlang -action tokens -language Erlang -inputfile ".\test\data\Erlang\list_comprehension.erl" -expected ".\test\ref\tokens\Erlang\list_comprehension.txt"
test\bin\run_test.ps1 -json -name send_receive-erlang -action tokens -language Erlang -inputfile ".\test\data\Erlang\send_receive.erl" -expected ".\test\ref\tokens\Erlang\send_receive.txt"
...
test\bin\run_test.ps1 -json -name antwalk-fs -action tokens -language Fsharp -inputfile ".\test\data\Fsharp\ant_walk.fs" -expected ".\test\ref\tokens\Fsharp\ant_walk.txt"
...
# Modula-2
test\bin\run_test.ps1 -json -name C64ToIBM-mod2 -action tokens -language Modula-2 -inputfile ".\test\data\Modula-2\C64ToIBM.mod" -expected ".\test\ref\tokens\Modula-2\C64ToIBM.txt"
test\bin\run_test.ps1 -json -name CaseDemo-mod2 -action tokens -language Modula-2 -inputfile ".\test\data\Modula-2\CaseDemo.mod" -expected ".\test\ref\tokens\Modula-2\CaseDemo.txt"
test\bin\run_test.ps1 -json -name game_def-mod2 -action tokens -language Modula-2 -inputfile ".\test\data\Modula-2\game.def" -expected ".\test\ref\tokens\Modula-2\game_def.txt"
test\bin\run_test.ps1 -json -name game-mod2 -action tokens -language Modula-2 -inputfile ".\test\data\Modula-2\game.mod" -expected ".\test\ref\tokens\Modula-2\game.txt"
test\bin\run_test.ps1 -json -name LoopDemo-mod2 -action tokens -language Modula-2 -inputfile ".\test\data\Modula-2\LoopDemo.mod" -expected ".\test\ref\tokens\Modula-2\LoopDemo.txt"
test\bin\run_test.ps1 -json -name PigLatin-mod2 -action tokens -language Modula-2 -inputfile ".\test\data\Modula-2\PigLatin.mod" -expected ".\test\ref\tokens\Modula-2\PigLatin.txt"
test\bin\run_test.ps1 -json -name TempConv-mod2 -action tokens -language Modula-2 -inputfile ".\test\data\Modula-2\TempConv.mod" -expected ".\test\ref\tokens\Modula-2\TempConv.txt"
...
# OCaml
test\bin\run_test.ps1 -json -name antwalk-ocaml -action tokens -language OCaml -inputfile ".\test\data\OCaml\ant_walk.ml" -expected ".\test\ref\tokens\OCaml\ant_walk.txt"
...
# SQL
test\bin\run_test.ps1 -json -name microsoft-sql -action tokens -language SQL -inputfile ".\test\data\SQL\microsoft.sql" -expected ".\test\ref\tokens\SQL\microsoft.txt"
test\bin\run_test.ps1 -json -name table-sql -action tokens -language SQL -inputfile ".\test\data\SQL\table.sql" -expected ".\test\ref\tokens\SQL\table.txt"

# T-SQL
test\bin\run_test.ps1 -json -name brackets-tsql -action tokens -language T-SQL -inputfile ".\test\data\T-SQL\brackets.sql" -expected ".\test\ref\tokens\T-SQL\brackets.txt"
