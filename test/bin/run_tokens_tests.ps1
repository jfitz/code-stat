...
test\bin\run_test.ps1 -json -name freeformat1 -action tokens -language Free-Format-COBOL -inputfile ".\test\data\COBOL\Free Format 1.COB" -expected ".\test\ref\tokens\COBOL\Free Format 1.txt"
test\bin\run_test.ps1 -json -name freeformat2 -action tokens -language Free-Format-COBOL -inputfile ".\test\data\COBOL\Free Format 2.COB" -expected ".\test\ref\tokens\COBOL\Free Format 2.txt"
test\bin\run_test.ps1 -json -name freeformat3 -action tokens -language Free-Format-COBOL -inputfile ".\test\data\COBOL\Free Format 3.COB" -expected ".\test\ref\tokens\COBOL\Free Format 3.txt"
test\bin\run_test.ps1 -json -name freeformat4 -action tokens -language Free-Format-COBOL -inputfile ".\test\data\COBOL\Free Format 4.COB" -expected ".\test\ref\tokens\COBOL\Free Format 4.txt"
