...
# generic
test\bin\run_test.ps1 -json -name adabkend-adb -action tokens -inputfile ".\test\data\Ada-83\adabkend.adb" -expected ".\test\ref\tokens\generic\adabkend-adb.txt"
test\bin\run_test.ps1 -json -name rockt2 -action tokens -inputfile ".\test\data\BASIC\rockt2.bas" -expected ".\test\ref\tokens\generic\rockt2.txt"
test\bin\run_test.ps1 -json -name parser -action tokens -inputfile ".\test\data\C\parser.c" -expected ".\test\ref\tokens\generic\parser.txt"
test\bin\run_test.ps1 -json -name PROG13-3 -action tokens -inputfile ".\test\data\COBOL-85\PROG13-3.cob" -expected ".\test\ref\tokens\generic\prog13-3.txt"
test\bin\run_test.ps1 -json -name calculator3 -action tokens -inputfile ".\test\data\Csharp\calculator3.cs" -expected ".\test\ref\tokens\generic\calculator3.txt"
test\bin\run_test.ps1 -json -name heron -action tokens -inputfile ".\test\data\FORTRAN-77\HERON.F77" -expected ".\test\ref\tokens\generic\heron.txt"
test\bin\run_test.ps1 -json -name bing -action tokens -inputfile ".\test\data\JavaScript\bing.js" -expected ".\test\ref\tokens\generic\bing.txt"
test\bin\run_test.ps1 -json -name family-main -action tokens -inputfile ".\test\data\Prolog\family-main.pl" -expected ".\test\ref\tokens\generic\family-main.txt"
test\bin\run_test.ps1 -json -name ETM-540-05 -action tokens -inputfile ".\test\data\R\ETM-540-05.R" -expected ".\test\ref\tokens\generic\etm-540-05.txt"
test\bin\run_test.ps1 -json -name basic -action tokens -inputfile ".\test\data\Ruby\basic.rb" -expected ".\test\ref\tokens\generic\basic.txt"
test\bin\run_test.ps1 -json -name microsoft -action tokens -inputfile ".\test\data\SQL-92\microsoft.sql" -expected ".\test\ref\tokens\generic\microsoft.txt"
test\bin\run_test.ps1 -json -name spider -action tokens -inputfile ".\test\data\VisualBasic-6\spider.bas" -expected ".\test\ref\tokens\generic\spider.txt"

# generic with comments
test\bin\run_test.ps1 -json -name adabkend-adb -action tokens -comment ada -inputfile ".\test\data\Ada-83\adabkend.adb" -expected ".\test\ref\tokens\generic-comments\adabkend-adb.txt"
test\bin\run_test.ps1 -json -name rockt2 -action tokens -comment basic -inputfile ".\test\data\BASIC\rockt2.bas" -expected ".\test\ref\tokens\generic-comments\rockt2.txt"
test\bin\run_test.ps1 -json -name parser -action tokens -comment c -inputfile ".\test\data\C\parser.c" -expected ".\test\ref\tokens\generic-comments\parser.txt"
test\bin\run_test.ps1 -json -name PROG13-3 -action tokens -comment cobol -inputfile ".\test\data\COBOL-85\PROG13-3.cob" -expected ".\test\ref\tokens\generic-comments\prog13-3.txt"
test\bin\run_test.ps1 -json -name calculator3 -action tokens -comment cpp -inputfile ".\test\data\Csharp\calculator3.cs" -expected ".\test\ref\tokens\generic-comments\calculator3.txt"
test\bin\run_test.ps1 -json -name heron -action tokens -comment fortran -inputfile ".\test\data\FORTRAN-77\HERON.F77" -expected ".\test\ref\tokens\generic-comments\heron.txt"
test\bin\run_test.ps1 -json -name bing -action tokens -comment hash -inputfile ".\test\data\JavaScript\bing.js" -expected ".\test\ref\tokens\generic-comments\bing.txt"
test\bin\run_test.ps1 -json -name family-main -action tokens -comment percent -inputfile ".\test\data\Prolog\family-main.pl" -expected ".\test\ref\tokens\generic-comments\family-main.txt"
test\bin\run_test.ps1 -json -name ETM-540-05 -action tokens -comment hash -inputfile ".\test\data\R\ETM-540-05.R" -expected ".\test\ref\tokens\generic-comments\etm-540-05.txt"
test\bin\run_test.ps1 -json -name basic -action tokens -comment hash -inputfile ".\test\data\Ruby\basic.rb" -expected ".\test\ref\tokens\generic-comments\basic.txt"
test\bin\run_test.ps1 -json -name microsoft -action tokens -comment ada -inputfile ".\test\data\SQL-92\microsoft.sql" -expected ".\test\ref\tokens\generic-comments\microsoft.txt"
test\bin\run_test.ps1 -json -name spider -action tokens -comment basic -inputfile ".\test\data\VisualBasic-6\spider.bas" -expected ".\test\ref\tokens\generic-comments\spider.txt"
...
# Ada-95
test\bin\run_test.ps1 -json -name adabkend-adb-95 -action tokens -language Ada-95 -inputfile ".\test\data\Ada-83\adabkend.adb" -expected ".\test\ref\tokens\Ada-95\adabkend-adb.txt"
test\bin\run_test.ps1 -json -name adabkend-ads-95 -action tokens -language Ada-95 -inputfile ".\test\data\Ada-83\adabkend.ads" -expected ".\test\ref\tokens\Ada-95\adabkend-ads.txt"
test\bin\run_test.ps1 -json -name signup-adb-95 -action tokens -language Ada-95 -inputfile ".\test\data\Ada-83\signup.adb" -expected ".\test\ref\tokens\Ada-95\signup-adb.txt"

# Ada-2005
test\bin\run_test.ps1 -json -name adabkend-adb-2005 -action tokens -language Ada-2005 -inputfile ".\test\data\Ada-83\adabkend.adb" -expected ".\test\ref\tokens\Ada-2005\adabkend-adb.txt"
test\bin\run_test.ps1 -json -name adabkend-ads-2005 -action tokens -language Ada-2005 -inputfile ".\test\data\Ada-83\adabkend.ads" -expected ".\test\ref\tokens\Ada-2005\adabkend-ads.txt"
test\bin\run_test.ps1 -json -name signup-adb-2005 -action tokens -language Ada-2005 -inputfile ".\test\data\Ada-83\signup.adb" -expected ".\test\ref\tokens\Ada-2005\signup-adb.txt"

# Ada-2012
test\bin\run_test.ps1 -json -name adabkend-adb-2012 -action tokens -language Ada-2012 -inputfile ".\test\data\Ada-83\adabkend.adb" -expected ".\test\ref\tokens\Ada-2012\adabkend-adb.txt"
