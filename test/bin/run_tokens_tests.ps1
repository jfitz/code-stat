...
test\bin\run_test.ps1 -json -name example-flowmatic -action $action -language $language -inputfile ".\test\data\$language\example.txt" -expected ".\test\ref\$action\$language\example.txt"
