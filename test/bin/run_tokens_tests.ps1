...
test\bin\run_test.ps1 -name hrdb -action tokens -language Cpp -inputfile ".\test\data\Cpp\hrdb.cpp" -expected ".\test\ref\tokens\Cpp\hrdb.txt"
test\bin\run_test.ps1 -name date_h -action tokens -language Cpp -inputfile ".\test\data\Cpp\date.h" -expected ".\test\ref\tokens\Cpp\date_h.txt"
test\bin\run_test.ps1 -name date_cpp -action tokens -language Cpp -inputfile ".\test\data\Cpp\date.cpp" -expected ".\test\ref\tokens\Cpp\date_cpp.txt"
