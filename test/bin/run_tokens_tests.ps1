...
test\bin\run_test.ps1 -json -name prog1 -action tokens -language COBOL-85 -inputfile ".\test\data\COBOL-85\PROG1.COB" -expected ".\test\ref\tokens\COBOL-85\PROG1.txt"
test\bin\run_test.ps1 -json -name prog2 -action tokens -language COBOL-85 -inputfile ".\test\data\COBOL-85\PROG2.COB" -expected ".\test\ref\tokens\COBOL-85\PROG2.txt"
test\bin\run_test.ps1 -json -name prog3 -action tokens -language COBOL-85 -inputfile ".\test\data\COBOL-85\PROG3.COB" -expected ".\test\ref\tokens\COBOL-85\PROG3.txt"
test\bin\run_test.ps1 -json -name prog4 -action tokens -language COBOL-85 -inputfile ".\test\data\COBOL-85\PROG4.COB" -expected ".\test\ref\tokens\COBOL-85\PROG4.txt"
test\bin\run_test.ps1 -json -name prog5 -action tokens -language COBOL-85 -inputfile ".\test\data\COBOL-85\PROG5.COB" -expected ".\test\ref\tokens\COBOL-85\PROG5.txt"
test\bin\run_test.ps1 -json -name prog6 -action tokens -language COBOL-85 -inputfile ".\test\data\COBOL-85\PROG6.COB" -expected ".\test\ref\tokens\COBOL-85\PROG6.txt"
test\bin\run_test.ps1 -json -name prog12-2 -action tokens -language COBOL-85 -inputfile ".\test\data\COBOL-85\PROG12-2.COB" -expected ".\test\ref\tokens\COBOL-85\PROG12-2.txt"
test\bin\run_test.ps1 -json -name prog13-3 -action tokens -language COBOL-85 -inputfile ".\test\data\COBOL-85\PROG13-3.COB" -expected ".\test\ref\tokens\COBOL-85\PROG13-3.txt"
test\bin\run_test.ps1 -json -name prog14-2 -action tokens -language COBOL-85 -inputfile ".\test\data\COBOL-85\PROG14-2.COB" -expected ".\test\ref\tokens\COBOL-85\PROG14-2.txt"
test\bin\run_test.ps1 -json -name prog15-4 -action tokens -language COBOL-85 -inputfile ".\test\data\COBOL-85\PROG15-4.COB" -expected ".\test\ref\tokens\COBOL-85\PROG15-4.txt"
test\bin\run_test.ps1 -json -name exec1 -action tokens -language COBOL-85 -inputfile ".\test\data\COBOL-85\UNLDDBCU2.COB" -tabsize 4 -expected ".\test\ref\tokens\COBOL-85\UNLDDBCU2.txt"
