...
class OctaveExaminer(Examiner):
  ...
  def __init__(self, code):
    ...
    block_comment_m_tb = ParenStarCommentTokenBuilder('%{', '%}')
    block_comment_o_tb = ParenStarCommentTokenBuilder('#{', '#}')
    ...
    'else', 'elseif', 'end', 'endfor', 'endif', 'endwhile',
    'for', 'function',
    'global',
    'if',
    'otherwise',
